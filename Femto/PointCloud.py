...
if __name__ == "__main__":
    ...
    """
    # pcl = Cloud(file='models/my_test_cloud_2.txt')
    # pcl.visualize()
    # pcd or ply files open with the Open3D library
    # pcl = Cloud(file='models/model.pcd')
    # pcl1 = Cloud(file='models/mate/lyy2.ply')
    # pcl2 = Cloud(file ='models/test.ply')
    """
    ...
    """
    """ TXT files """
    # pcl = Cloud(file='models/my_test_cloud_2.txt', depth=True)
    # pcl.visualize()
    # pcl = Cloud(file='models/test_cloud_8.txt', color=True)
    # pcl.visualize()
    """ PLY files creation """
    if os.path.exists('models/test.ply'):
        os.remove('models/test.ply')
    # file = open('models/lyy.ply', 'w').close()
    pcl = Cloud(file='models/test.ply', depth=True)
    pcl = Cloud(file='models/test.ply', color=True)
    """ PCD files creation """
    ...
    # print(pcl._dynamic_point_cloud)
    # points=mapper.world_points_2_color(pcl._kinect,_CameraSpacePoint,pcl._dynamic_point_cloud)
    # print(points)

    # import pandas as pd
    # path = 'models/my_test_cloud_1.txt'
